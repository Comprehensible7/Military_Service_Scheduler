package com.teamproject.aaaaan_2.uihelpers;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = null;//ContextCompat.getDrawable(context, R.drawable.np_numberpicker_selection_divider);
        ...
        mSelectedTypeface = Typeface.create(attributesArray.getString(R.styleable.NumberPicker_np_selectedTypeface), Typeface.NORMAL);
...
//        }
    ...
    public void setSelectedTypeface(Typeface typeface) {
        ...
        if (mSelectedTypeface != null) {
            mSelectedText.setTypeface(mSelectedTypeface);
            //mSelectorWheelPaint.setTypeface(mSelectedTypeface);
        } else {
            mSelectedText.setTypeface(Typeface.MONOSPACE);
            //mSelectorWheelPaint.setTypeface(Typeface.MONOSPACE);
