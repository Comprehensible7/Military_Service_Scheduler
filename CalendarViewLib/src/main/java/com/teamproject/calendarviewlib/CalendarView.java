package com.teamproject.calendarviewlib;
...
import com.teamproject.calendarviewlib.helpers.FrameLinearLayout;
import com.teamproject.calendarviewlib.helpers.MultipleTriangleView;
import com.teamproject.calendarviewlib.helpers.SelectedTextView;
import com.teamproject.calendarviewlib.helpers.YMDCalendar;
...
public class CalendarView extends FrameLayout {
    ...
    private class CalendarPagerAdapter extends PagerAdapter {
        ...
        private void onBindView(int position,
            ...
            // Set current day, 캘린더에 들어가는 날짜를 toCalendar해주어 Calendar에서 읽을 수 있게 해줌
    ...
    public static class CalendarObject {
        ...
        public CalendarObject(String id, String title,Calendar datetime, int primaryColor, int secondaryColor) {
            mID = id;
            mTitle = title;
            mDatetime = datetime;
